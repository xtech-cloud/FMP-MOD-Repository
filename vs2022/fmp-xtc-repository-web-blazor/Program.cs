...
using XTC.FMP.MOD.Repository.App.Web;
...
public partial class Program
{
    public static async Task Main(string[] args)
    {
        ...
        permissioS[Permissions.AgentCreate] = "";
        permissioS[Permissions.AgentUpdate] = "";
        ...
        permissioS[Permissions.ModuleCreate] = "";
        permissioS[Permissions.ModuleUpdate] = "";
        permissioS[Permissions.ModuleRetrieve] = "";
        permissioS[Permissions.ModuleDelete] = "";

        permissioS[Permissions.PluginCreate] = "";
        permissioS[Permissions.PluginUpdate] = "";
        permissioS[Permissions.PluginRetrieve] = "";
        permissioS[Permissions.PluginDelete] = "";
        ...
        framework.setUserData("XTC.FMP.MOD.Repository.LIB.MVCS.Entry", entry);
