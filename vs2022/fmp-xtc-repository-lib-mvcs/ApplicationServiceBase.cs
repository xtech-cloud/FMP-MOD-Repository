...
namespace XTC.FMP.MOD.Repository.LIB.MVCS
{
    ...
    /// Application服务层基类
    /// </summary>
    public class ApplicationServiceBase : Service
    {
        public ApplicationServiceMock mock { get; set; } = new ApplicationServiceMock();
        ...
        public ApplicationServiceBase(string _uid, string _gid) : base(_uid)
        {
            gid_ = _gid;
        }
        ...
        /// <returns>错误</returns>
        public virtual async Task<Error> CallCreate(ApplicationCreateRequest? _request, object? _context)
        {
        ...
        /// <returns>错误</returns>
        public virtual async Task<Error> CallUpdate(ApplicationUpdateRequest? _request, object? _context)
        {
        ...
        public virtual async Task<Error> CallRetrieve(UuidRequest? _request, object? _context)
        {
            ...
            ApplicationRetrieveResponse? response = null;
        ...
        /// <returns>错误</returns>
        public virtual async Task<Error> CallList(ApplicationListRequest? _request, object? _context)
        {
            ...
            ApplicationListResponse? response = null;
        ...
        /// <returns>错误</returns>
        public virtual async Task<Error> CallSearch(ApplicationSearchRequest? _request, object? _context)
        {
        ...
        {
            if(null == model_)
                model_ = findModel(ApplicationModel.NAME + "." + gid_) as ApplicationModel;
            return model_;
        }
        ...
        protected Application.ApplicationClient? getGrpcClient()
        {
            if (null == grpcChannel_)
                return null;

            if(null == clientApplication_)
            {
                clientApplication_ = new Application.ApplicationClient(grpcChannel_);
            }
        ...
        /// GRPC客户端
        /// </summary>
        protected Application.ApplicationClient? clientApplication_;
        ...
        /// 直系数据层
        /// </summary>
        private ApplicationModel? model_;
    }
