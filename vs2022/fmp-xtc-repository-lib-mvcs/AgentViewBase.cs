...
namespace XTC.FMP.MOD.Repository.LIB.MVCS
{
    ...
    public class AgentViewBase : View
    {
        ...
        public virtual void RefreshProtoRetrieve(Error _err, AgentRetrieveResponseDTO _dto, object? _context)
        {
            var bridge = getFacade()?.getUiBridge() as IAgentUiBridge; 
            if (!Error.IsOK(_err))
            {
        ...
        public virtual void RefreshProtoList(Error _err, AgentListResponseDTO _dto, object? _context)
        {
            var bridge = getFacade()?.getUiBridge() as IAgentUiBridge; 
            if (!Error.IsOK(_err))
            {
        ...
        /// <param name="_err">错误</param>
        /// <param name="_dto">AgentListResponse的数据传输对象</param>
        public virtual void RefreshProtoSearch(Error _err, AgentListResponseDTO _dto, object? _context)
        {
            var bridge = getFacade()?.getUiBridge() as IAgentUiBridge; 
            if (!Error.IsOK(_err))
            {
