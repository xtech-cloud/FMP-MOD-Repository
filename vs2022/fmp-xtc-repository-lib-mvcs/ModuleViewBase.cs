...
namespace XTC.FMP.MOD.Repository.LIB.MVCS
{
    ...
    public class ModuleViewBase : View
    {
        ...
        public virtual void RefreshProtoRetrieve(Error _err, ModuleRetrieveResponseDTO _dto, object? _context)
        {
            var bridge = getFacade()?.getUiBridge() as IModuleUiBridge; 
            if (!Error.IsOK(_err))
            {
        ...
        public virtual void RefreshProtoList(Error _err, ModuleListResponseDTO _dto, object? _context)
        {
            var bridge = getFacade()?.getUiBridge() as IModuleUiBridge; 
            if (!Error.IsOK(_err))
            {
        ...
        /// <param name="_err">错误</param>
        /// <param name="_dto">ModuleListResponse的数据传输对象</param>
        public virtual void RefreshProtoSearch(Error _err, ModuleListResponseDTO _dto, object? _context)
        {
            var bridge = getFacade()?.getUiBridge() as IModuleUiBridge; 
            if (!Error.IsOK(_err))
            {
