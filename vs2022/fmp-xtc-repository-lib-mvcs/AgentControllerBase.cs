...
namespace XTC.FMP.MOD.Repository.LIB.MVCS
{
    ...
    public class AgentControllerBase : Controller
    {
        ...
        public virtual void UpdateProtoCreate(AgentModel.AgentStatus? _status, UuidResponse _response, SynchronizationContext? _context)
        {
        ...
        public virtual void UpdateProtoUpdate(AgentModel.AgentStatus? _status, UuidResponse _response, SynchronizationContext? _context)
        {
            Error err = new Error(_response.Status.Code, _response.Status.Message);
            UuidResponseDTO? dto = new UuidResponseDTO(_response);
        ...
        public virtual void UpdateProtoRetrieve(AgentModel.AgentStatus? _status, AgentRetrieveResponse _response, SynchronizationContext? _context)
        {
            Error err = new Error(_response.Status.Code, _response.Status.Message);
        ...
        public virtual void UpdateProtoDelete(AgentModel.AgentStatus? _status, UuidResponse _response, SynchronizationContext? _context)
        {
            Error err = new Error(_response.Status.Code, _response.Status.Message);
            UuidResponseDTO? dto = new UuidResponseDTO(_response);
        ...
        public virtual void UpdateProtoList(AgentModel.AgentStatus? _status, AgentListResponse _response, SynchronizationContext? _context)
        {
            Error err = new Error(_response.Status.Code, _response.Status.Message);
        ...
        public virtual void UpdateProtoSearch(AgentModel.AgentStatus? _status, AgentListResponse _response, SynchronizationContext? _context)
        {
            Error err = new Error(_response.Status.Code, _response.Status.Message);
            AgentListResponseDTO? dto = new AgentListResponseDTO(_response);
        ...
        public virtual void UpdateProtoPrepareUpload(AgentModel.AgentStatus? _status, PrepareUploadResponse _response, SynchronizationContext? _context)
        {
            Error err = new Error(_response.Status.Code, _response.Status.Message);
        ...
        public virtual void UpdateProtoFlushUpload(AgentModel.AgentStatus? _status, FlushUploadResponse _response, SynchronizationContext? _context)
        {
            Error err = new Error(_response.Status.Code, _response.Status.Message);
        ...
        public virtual void UpdateProtoAddFlag(AgentModel.AgentStatus? _status, FlagOperationResponse _response, SynchronizationContext? _context)
        {
            Error err = new Error(_response.Status.Code, _response.Status.Message);
        ...
        public virtual void UpdateProtoRemoveFlag(AgentModel.AgentStatus? _status, FlagOperationResponse _response, SynchronizationContext? _context)
        {
            Error err = new Error(_response.Status.Code, _response.Status.Message);
            FlagOperationResponseDTO? dto = new FlagOperationResponseDTO(_response);
