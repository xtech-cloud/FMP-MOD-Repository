...
namespace XTC.FMP.MOD.Repository.LIB.MVCS
{
    ...
    public class ModuleControllerBase : Controller
    {
        ...
        public virtual void UpdateProtoCreate(ModuleModel.ModuleStatus? _status, UuidResponse _response, object? _context)
        {
        ...
        public virtual void UpdateProtoUpdate(ModuleModel.ModuleStatus? _status, UuidResponse _response, object? _context)
        {
            Error err = new Error(_response.Status.Code, _response.Status.Message);
            UuidResponseDTO? dto = new UuidResponseDTO(_response);
        ...
        public virtual void UpdateProtoRetrieve(ModuleModel.ModuleStatus? _status, ModuleRetrieveResponse _response, object? _context)
        {
            Error err = new Error(_response.Status.Code, _response.Status.Message);
        ...
        public virtual void UpdateProtoDelete(ModuleModel.ModuleStatus? _status, UuidResponse _response, object? _context)
        {
            Error err = new Error(_response.Status.Code, _response.Status.Message);
            UuidResponseDTO? dto = new UuidResponseDTO(_response);
        ...
        public virtual void UpdateProtoList(ModuleModel.ModuleStatus? _status, ModuleListResponse _response, object? _context)
        {
            Error err = new Error(_response.Status.Code, _response.Status.Message);
        ...
        public virtual void UpdateProtoSearch(ModuleModel.ModuleStatus? _status, ModuleListResponse _response, object? _context)
        {
            Error err = new Error(_response.Status.Code, _response.Status.Message);
            ModuleListResponseDTO? dto = new ModuleListResponseDTO(_response);
        ...
        public virtual void UpdateProtoPrepareUpload(ModuleModel.ModuleStatus? _status, PrepareUploadResponse _response, object? _context)
        {
            Error err = new Error(_response.Status.Code, _response.Status.Message);
        ...
        public virtual void UpdateProtoFlushUpload(ModuleModel.ModuleStatus? _status, FlushUploadResponse _response, object? _context)
        {
            Error err = new Error(_response.Status.Code, _response.Status.Message);
        ...
        public virtual void UpdateProtoAddFlag(ModuleModel.ModuleStatus? _status, FlagOperationResponse _response, object? _context)
        {
            Error err = new Error(_response.Status.Code, _response.Status.Message);
        ...
        public virtual void UpdateProtoRemoveFlag(ModuleModel.ModuleStatus? _status, FlagOperationResponse _response, object? _context)
        {
            Error err = new Error(_response.Status.Code, _response.Status.Message);
            FlagOperationResponseDTO? dto = new FlagOperationResponseDTO(_response);
