...
namespace XTC.FMP.MOD.Repository.LIB.MVCS
{
    ...
    public class ModuleControllerBase : Controller
    {
        ...
        public virtual void UpdateProtoAddFlag(ModuleModel.ModuleStatus? _status, FlagOperationResponse _response, SynchronizationContext? _context)
        {
            Error err = new Error(_response.Status.Code, _response.Status.Message);
        ...
        public virtual void UpdateProtoRemoveFlag(ModuleModel.ModuleStatus? _status, FlagOperationResponse _response, SynchronizationContext? _context)
        {
            Error err = new Error(_response.Status.Code, _response.Status.Message);
            FlagOperationResponseDTO? dto = new FlagOperationResponseDTO(_response);
