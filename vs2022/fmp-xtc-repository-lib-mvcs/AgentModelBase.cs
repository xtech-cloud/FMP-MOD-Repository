...
namespace XTC.FMP.MOD.Repository.LIB.MVCS
{
    ...
    public class AgentModelBase : Model
    {
        ...
        public virtual void UpdateProtoRetrieve(AgentRetrieveResponse _response, SynchronizationContext? _context)
        {
        ...
        public virtual void UpdateProtoList(AgentListResponse _response, SynchronizationContext? _context)
        {
        ...
        public virtual void UpdateProtoSearch(AgentListResponse _response, SynchronizationContext? _context)
        {
